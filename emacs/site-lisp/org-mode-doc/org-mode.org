...
(if (boundp 'org-user-directory)
    (setq org-directory org-user-directory)
...
*NOTE:* This agenda screen shot is out of date and do not currently match the agenda setup in this document.
...
;; The following setting is different from the document so that you
;; can override the document path by setting your path in the variable
;; org-mode-user-info-directory
;;
(if (boundp 'org-mode-user-info-directory)
    (add-to-list 'Info-default-directory-list org-mode-user-info-directory)
  (add-to-list 'Info-default-directory-list "~/git/org-mode/doc"))
#+end_src
