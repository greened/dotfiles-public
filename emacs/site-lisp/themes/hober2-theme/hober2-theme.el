;;; hober2-theme.el --- Edward O'Connor's second theme.

;; Copyright (C) 1997 -- 2011 Edward O'Connor <ted@oconnor.cx>
...
(custom-theme-set-faces
 ...
 '(diff-hunk-header ((t (:background "gray30" :foreground "white"))))
 '(diff-hunk-header-face ((t (:background "gray30" :foreground "white"))))
 '(diff-removed ((t (:background "indian red" :foreground "white"))))
 '(diff-added ((t (:background "medium sea green" :foreground "white"))))
 ...
 '(erc-pal-face ((t (:foreground "khaki"))))
 ...
 '(gnus-cite-face-6 ((t (:foreground "medium sea green"))))
 '(gnus-cite-6 ((t (:foreground "medium sea green"))))
 ...
 '(gnus-summary-high-ticked ((t (:foreground "indian red"))))
